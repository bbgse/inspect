import { inspect as _inspect } from "../src";
import { expect } from "chai";

for (const [suite, inspect] of Object.entries({
  objects: _inspect,
  "objects (Object.create(null))": (obj: any, ...rest: any[]) =>
    _inspect(Object.assign(Object.create(null), obj), ...rest),
})) {
  describe(suite, () => {
