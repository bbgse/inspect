...
describe("functions", () => {
  ...
  describe("colors", () => {
    it("returns string with cyan color, if colour is set to true", () => {
      expect(inspect(function foo() {}, { colors: true })).to.equal(
